...
from .views import CreatePost, post_like, get_all_posts, get_user_posts, get_post_by_id , get_likes_by_post_id
...
urlpatterns=[
    ...
    path('id/<int:post_id>/likes_list/', get_likes_by_post_id, name='post-like'),
    ]
